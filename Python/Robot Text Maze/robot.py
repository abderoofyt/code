...
# stipulates when and what files are imported by checking the commandline
turtle_flag = False
...
BACK - move backward by specified number of steps, e.g. 'BAl
CK 10'
...
def robot_start():
    ...
    if turtle_flag == False:
        world.print_obstacle_list()
